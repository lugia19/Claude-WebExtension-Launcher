...
// prepareAdminContext makes sure Chromium's sandbox can start from our install
// location. On Ubuntu 24.04+ that needs a one-time, root-installed AppArmor profile;
