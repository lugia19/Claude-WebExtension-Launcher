...
// PrefetchedPackage / PrefetchedVersion are the Claude package the launcher
// downloaded (see Prefetch), handed to the worker via --package / --package-version.
// downloadAndExtract installs from it.
var (
